...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spacy-legacy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11764&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spacy-legacy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spacy-legacy` can be installed with:

```
conda install spacy-legacy
```

It is possible to list all of the versions of `spacy-legacy` available on your platform with:
